...
Nova's GitHub automation is split between a small number of YAML workflows and Python support scripts under `.github/`.
...
- the consolidated Project automation workflow and this health-check script are documented.
...
It is a safety net for follow-up work such as further splitting `project_automation.py`, reducing duplicated workflow dispatch logic, or removing obsolete migration helpers.
